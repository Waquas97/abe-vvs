...
src="office52-x-00001-12.ply.cpabe"
...
for i in $(seq 1 1440); do
    ...
    link_name="office52-x-${num}-12.ply.cpabe"
...
src="office52-x-00001-25.ply.cpabe"
...
for i in $(seq 1 1440); do
    ...
    # Define the name for the symbolic link.
    link_name="office52-x-${num}-25.ply.cpabe"
...
src="office52-x-00001-50.ply.cpabe"
...
for i in $(seq 1 1440); do
    ...
    # Define the name for the symbolic link.
    link_name="office52-x-${num}-50.ply.cpabe"
...
src="office52-x-00001-100.ply.cpabe"
...
for i in $(seq 1 1440); do
    ...
    # Define the name for the symbolic link.
    link_name="office52-x-${num}-100.ply.cpabe"
