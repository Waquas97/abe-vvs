...
src="108k-xyz-00001-12.ply.cpabe"
...
echo "Creating 240 symbolic links pointing to '$src'..."
...
for i in $(seq 1 240); do
    ...
    link_name="108k-xyz-${num}-12.ply.cpabe"
...
src="108k-xyz-00001-25.ply.cpabe"
...
for i in $(seq 1 240); do
    ...
    # Define the name for the symbolic link.
    link_name="108k-xyz-${num}-25.ply.cpabe"
...
src="108k-xyz-00001-50.ply.cpabe"
...
for i in $(seq 1 240); do
    ...
    # Define the name for the symbolic link.
    link_name="108k-xyz-${num}-50.ply.cpabe"
...
src="108k-xyz-00001-100.ply.cpabe"
...
for i in $(seq 1 240); do
    ...
    # Define the name for the symbolic link.
    link_name="108k-xyz-${num}-100.ply.cpabe"

    # Create the symbolic link using 'ln -s'.
    # This command creates a link named $link_name that points to the $src file.
    ln -s "$src" "$link_name"
done
echo "Successfully created 240 symbolic links."
