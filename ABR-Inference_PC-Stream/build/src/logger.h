...
typedef struct {
    ...
    int rep; // representation index chosen for this frame
    int bitrate; // bitrate for chosen representation (bps)
    size_t size_bytes; // size of frame in bytes
    double inference_ms; // inference time in ms (0 = skipped)
} FrameLog;
